...
#             model = ConvNet_3D(out_dim=out_dim)
            ...
            if args.model_type == 'resnet18':
                model = ResNet18(in_channels=1, num_classes=args.num_classes)
            elif args.model_type == 'resnet50':
                model = ResNet50(in_channels=1, num_classes=args.num_classes)
            elif args.model_type == 'vgg16':
                model = VGG16(in_channels=1, num_classes=args.num_classes)
            elif args.model_type == 'densenet121':
                model = DenseNet121(in_channels=1, num_classes=args.num_classes)
            elif args.model_type == 'convnext_base':
                model = ConvNeXt_Base(in_channels=1, num_classes=args.num_classes)
