...
if __name__ == '__main__':
    ...
    for i in range(groups_in_attrs[attr_to_idx[args.attribute_type]]):
        ...
        group_havo_dataset = FairVision_Glaucoma(os.path.join(args.data_dir, 'train'), modality_type=args.modality_types, task=args.task, resolution=args.image_size, attribute_type=args.attribute_type, needBalance=args.need_balance, dataset_proportion=args.dataset_proportion, select_group=i)
